                        ...
                        <div className="col-lg-8">
                            <div className="service-details-content">
                                <div className="content">
                                    ...
                                    <p>
                                        Xiaofei Ge is committed to ensuring that the app is as
                                    ...
                                    <p>
                                        The Rond app stores and processes personal data that you
                                        ...
                                        Rond app won’t work properly or at all.
                                    </p>
                                    <div>
                                        <p>
                                    ...
                                    <p>
                                        ...
                                        Xiaofei Ge will not take responsibility for. Certain
                                        functions of the app will require the app to have an active
                                        internet connection. The connection can be Wi-Fi or provided
                                        by your mobile network provider, but Xiaofei Ge cannot take
                                    ...
                                    <p>
                                        Along the same lines, Xiaofei Ge cannot always take
                                        responsibility for the way you use the app i.e. You need to
                                        make sure that your device stays charged – if it runs out of
                                        battery and you can’t turn it on to avail the Service,
                                        Xiaofei Ge cannot accept responsibility.
                                    </p>
                                    <p>
                                        With respect to Xiaofei Ge’s responsibility for your use of
                                        ...
                                        available to you. Xiaofei Ge accepts no liability for any
                                    ...
                                    <p>
                                        ...
                                        system(and for any additional systems we decide to extend
                                        the availability of the app to) may change, and you’ll need
                                        to download the updates if you want to keep using the app.
                                        Xiaofei Ge does not promise that it will always update the
                                        app so that it is relevant to you and/or works with the iOS
                                        ...
                                        and may terminate use of it at any time without giving
                                        notice of termination to you. Unless we tell you otherwise,
                                        upon any termination, (a) the rights and licenses granted to
                                        you in these terms will end; (b) you must stop using the
                                    ...
                                    <p>These terms and conditions are effective as of 2023-04-29</p>
                                    <h4>Contact Us</h4>
                                    <p>
